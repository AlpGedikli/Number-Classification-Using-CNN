...
plt.figure()
plt.plot(hist.history["loss"],label = "Egitim Kaybi")
plt.plot(hist.history["val_loss"],label = "Validation Kaybi")
plt.legend()
plt.show()


score = model.evaluate(x_test,y_test,verbose=1) #verbose gorsellestirme
...
cm = confusion_matrix(y_true,y_prediction_class)

f,ax = plt.subplots(figsize = (8,8))
sns.heatmap(cm,annot=True,linewidths=0.01,cmap="green",linecolor="gray",fmt=".1f",ax=ax)
